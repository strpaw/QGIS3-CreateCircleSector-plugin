...
class CreateCircleSector:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CreateCircleSector_{}.qm'.format(locale))
        ...
        self.dlg = CreateCircleSectorDialog()

        self.dlg.pushButtonAddCircleSector.clicked.connect(self.add_circle_sector)

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&CreateCircleSector')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'CreateCircleSector')
        self.toolbar.setObjectName(u'CreateCircleSector')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CreateCircleSector', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/create_circ_sector/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'CreateCircleSector'),
            callback=self.run,
